...
本文件保留 2026 春／夏第一個完整資料切片的歷史範圍。現行產品已擴展至二十五季、1,750 個唯一作品及 3,785 筆 OP／ED；目前架構見 [`ARCHITECTURE.md`](./ARCHITECTURE.md)，來源契約見 [`DATA_PROVENANCE.md`](./DATA_PROVENANCE.md)。

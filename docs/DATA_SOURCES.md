...
目前已發布的審核快照為：2026 夏季 70 套、2026 春季 70 套、2026 冬季 66 套、2025 夏季 75 套、2025 春季 82 套、2025 冬季 59 套、2024 秋季 88 套、2024 夏季 68 套、2024 春季 76 套、2024 冬季 75 套、2023 秋季 100 套、2023 夏季 75 套、2023 春季 79 套及 2023 冬季 72 套，共 1,054 個作品詳情、2,186 筆 OP／ED 與 536 個唯一歌曲層 YouTube 直連；其中 1,104 筆已保留官方或正式授權影片 metadata。
...
每首已發布歌曲在 `PublicTheme.sources[]` 留下 URL、語言、`first_party`／`cross_check` 角色及核對日期。十四季快照的 2,186 筆歌曲都必須同時具備兩種角色；這是公開 provenance gate，不是 confidence score。第三方索引將歌曲標為 OP／ED、但第一方頁面只證實其他改編版本或一般「主題歌」時，不把它升格為動畫 OP／ED。完整欄位與媒體邊界見 [`DATA_PROVENANCE.md`](./DATA_PROVENANCE.md)。

...
目前 source 版本：**v1.37.1**。歌曲卡片將共同署名按職務整理，完整保留每位創作者，並顯示已有的發行日期及版本說明；缺少日期時不顯示日期列，長動畫名稱在窄欄完整換行，目錄與 API 資料不變。目錄共有 29 個季度、1,937 套作品與 4,277 筆 OP／ED；春季為 20 套作品、48 筆歌曲，春、夏季仍在補充，2025 秋季尚未收錄。
...
| -------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 公開靜態目錄 / Public static catalogue | Source 版本為 `v1.37.1`；正式發布狀態以對應 Release 驗收摘要為準 | [入口網站 / Live](https://anisonary.k-y.cc) · [版本與驗收 / Releases](https://github.com/kyeunga25/anisonary/releases) · [資料來源 / Sources](docs/DATA_SOURCES.md) · [安全政策 / Security](SECURITY.md) · [授權 / Licence](LICENSING.md) · [版權 / Copyright](COPYRIGHT.md) |

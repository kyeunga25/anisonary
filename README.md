...
目前 source 版本：**v1.40.2**。較長的歌曲來源清單可按需展開，來源數量、審閱狀態與核對日期持續可見；支援鍵盤及無 JavaScript 操作，減少手機閱讀時的捲動距離。目錄共有 29 個季度、1,944 套作品與 4,292 筆 OP／ED；春季為 27 套作品、63 筆歌曲，春、夏季仍在補充，2025 秋季尚未收錄。
...
| -------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 公開靜態目錄 / Public static catalogue | Source 版本為 `v1.40.2`；正式發布狀態以對應 Release 驗收摘要為準 | [入口網站 / Live](https://anisonary.k-y.cc) · [版本與驗收 / Releases](https://github.com/kyeunga25/anisonary/releases) · [資料來源 / Sources](docs/DATA_SOURCES.md) · [安全政策 / Security](SECURITY.md) · [授權 / Licence](LICENSING.md) · [版權 / Copyright](COPYRIGHT.md) |

...
目前 source 版本：**v1.35.1**。歌曲來源較多時，核對連結移到歌曲資料下方並按可用寬度分欄；少量來源保留緊湊的桌面卡片，手機完整顯示連結及來源標記。目錄資料與 API 不變，共有 29 個季度、1,931 套作品與 4,259 筆 OP／ED；春季為 14 套作品、30 筆歌曲，春、夏季仍在補充，2025 秋季尚未收錄。
...
| -------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 公開靜態目錄 / Public static catalogue | Source 版本為 `v1.35.1`；正式發布狀態以對應 Release 驗收摘要為準 | [入口網站 / Live](https://anisonary.k-y.cc) · [版本與驗收 / Releases](https://github.com/kyeunga25/anisonary/releases) · [資料來源 / Sources](docs/DATA_SOURCES.md) · [安全政策 / Security](SECURITY.md) · [授權 / Licence](LICENSING.md) · [版權 / Copyright](COPYRIGHT.md) |

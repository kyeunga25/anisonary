...
This repository currently implements Phase 1 milestones M0–M4: project foundation, public data contract, provider abstraction, site shell, homepage, season directory, anime detail pages, theme credits, source verification, and empty states. All bundled records are explicitly fictional Mock Data.
...
- M0–M4 QA evidence: `docs/QA_PHASE1_M0_M4.md`

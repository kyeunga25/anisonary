...
This repository contains the completed static product: season directory, anime detail pages, traceable OP／ED credits and links, per-song source ledgers, source-attributed media, local-only cross-season search, privacy-bounded offline reading, a GitHub correction flow, and deployment through Cloudflare Workers Static Assets. The default catalogue covers twenty-nine reviewed snapshots across 2019–2026, with 1,940 unique titles and 4,284 known OP／ED records. The 2019 spring snapshot contains twenty-three TV titles, including a TV short; summer contains 38 TV titles and four web series. Both quarters are still being expanded, and 2025 fall is not yet included. Fictional Mock Data remains test-only.

目前 source 版本：**v1.38.0**。2019 春季加入《進擊的巨人》第三季後半、《異世界四重奏》與《南無阿彌陀佛!-蓮台 UTENA-》，新增 7 筆 OP／ED 與 3 筆官方影片 metadata；保留角色合唱、單集片尾、TV Size 與完整版及 CD 日期區別。目錄共有 29 個季度、1,940 套作品與 4,284 筆 OP／ED；春季為 23 套作品、55 筆歌曲，春、夏季仍在補充，2025 秋季尚未收錄。
...
| -------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 公開靜態目錄 / Public static catalogue | Source 版本為 `v1.38.0`；正式發布狀態以對應 Release 驗收摘要為準 | [入口網站 / Live](https://anisonary.k-y.cc) · [版本與驗收 / Releases](https://github.com/kyeunga25/anisonary/releases) · [資料來源 / Sources](docs/DATA_SOURCES.md) · [安全政策 / Security](SECURITY.md) · [授權 / Licence](LICENSING.md) · [版權 / Copyright](COPYRIGHT.md) |

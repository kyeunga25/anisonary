...
import { curated2019SummerThemeSources } from "@/data/curated-theme-sources/2019/summer";
import { curated2020FallThemeSources } from "@/data/curated-theme-sources/2020/fall";
import { curated2020SpringThemeSources } from "@/data/curated-theme-sources/2020/spring";
import { curated2020SummerThemeSources } from "@/data/curated-theme-sources/2020/summer";
import { curated2020WinterThemeSources } from "@/data/curated-theme-sources/2020/winter";
...
import { curated2021WinterThemeSources } from "@/data/curated-theme-sources/2021/winter";
import { curated2022FallThemeSources } from "@/data/curated-theme-sources/2022/fall";
import { curated2022SpringThemeSources } from "@/data/curated-theme-sources/2022/spring";
import { curated2022SummerThemeSources } from "@/data/curated-theme-sources/2022/summer";
import { curated2022WinterThemeSources } from "@/data/curated-theme-sources/2022/winter";
...
export const curatedThemeSourceRegistry = validateCuratedThemeSourceRegistry([
  ...
  { seasonId: "2022-fall", overrides: curated2022FallThemeSources },
  { seasonId: "2022-summer", overrides: curated2022SummerThemeSources },
  { seasonId: "2022-spring", overrides: curated2022SpringThemeSources },
  { seasonId: "2022-winter", overrides: curated2022WinterThemeSources },
  ...
  { seasonId: "2020-summer", overrides: curated2020SummerThemeSources },
  { seasonId: "2020-spring", overrides: curated2020SpringThemeSources },
  { seasonId: "2020-winter", overrides: curated2020WinterThemeSources },
  { seasonId: "2019-fall", overrides: curated2019FallThemeSources },
  { seasonId: "2019-summer", overrides: curated2019SummerThemeSources },
  { seasonId: "2019-spring", overrides: curated2019SpringThemeSources }
] as const);

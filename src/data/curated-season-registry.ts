...
import {
  curated2020SpringAnimeIds,
  curated2020SpringSeeds
} from "@/data/curated-seeds/2020/spring";
import {
  curated2020SummerAnimeIds,
  curated2020SummerSeeds
} from "@/data/curated-seeds/2020/summer";
import {
  curated2020WinterAnimeIds,
  curated2020WinterSeeds
} from "@/data/curated-seeds/2020/winter";
import {
...
export const curatedSeasonRegistry = validateCuratedSeasonRegistry([
  ...
  },
  {
    ...
    titleZhHant: "夏季動畫",
    titleJa: "2020年夏アニメ",
    seeds: curated2020SummerSeeds,
    animeIds: curated2020SummerAnimeIds
  },
  {
    id: "2020-spring",
    year: 2020,
    ...
    titleZhHant: "春季動畫",
    titleJa: "2020年春アニメ",
    seeds: curated2020SpringSeeds,
    animeIds: curated2020SpringAnimeIds
  },
  {
    id: "2020-winter",
    year: 2020,
    ...
    titleZhHant: "冬季動畫",
    titleJa: "2020年冬アニメ",
    seeds: curated2020WinterSeeds,
    animeIds: curated2020WinterAnimeIds
  },
  {
    id: "2019-fall",
    year: 2019,
  ...
  },
  {
    ...
    titleZhHant: "春季動畫",
    titleJa: "2019年春アニメ",
    coverageNote: "本季正在補充，目前收錄 38 套 TV 作品及 1 套網絡連載（含電視短篇及重編版）。其餘作品、跨季延續及特殊歌曲版本仍待核對。",
